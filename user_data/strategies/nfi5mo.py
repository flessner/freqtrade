...
class NFI5MO(IStrategy):
    ...
    buy_dip_threshold_6 = DecimalParameter(
        0.01, 0.2, default=0.06, space='buy', decimals=3, optimize=True, load=True)
    ...
    buy_dip_threshold_8 = DecimalParameter(
        0.2, 0.5, default=0.4, space='buy', decimals=3, optimize=True, load=True)
    # Loose dips
    ...
    buy_dip_threshold_12 = DecimalParameter(
        0.2, 0.5, default=0.66, space='buy', decimals=3, optimize=True, load=True)
    ...
    buy_pump_threshold_2 = DecimalParameter(
        0.4, 1.0, default=0.56, space='buy', decimals=3, optimize=True, load=True)
    # 48 hours
    ...
    buy_pump_threshold_4 = DecimalParameter(
        0.4, 1.0, default=0.4, space='buy', decimals=3, optimize=True, load=True)
    # 36 hours strict
    ...
    buy_pump_pull_threshold_9 = DecimalParameter(
        1.5, 3.0, default=1.4, space='buy', decimals=2, optimize=True, load=True)
    buy_pump_threshold_9 = DecimalParameter(
        0.4, 1.8, default=1.3, space='buy', decimals=3, optimize=True, load=True)
    ...
    buy_mfi_1 = DecimalParameter(
        20.0, 40.0, default=26.0, space='buy', decimals=1, optimize=True, load=True)

    buy_volume_2 = DecimalParameter(
        1.0, 10.0, default=2.6, space='buy', decimals=1, optimize=True, load=True)
    ...
    buy_ema_open_mult_5 = DecimalParameter(
        0.016, 0.03, default=0.019, space='buy', decimals=3, optimize=True, load=True)
    buy_bb_offset_5 = DecimalParameter(
        0.98, 1.0, default=0.999, space='buy', decimals=3, optimize=True, load=True)
    ...
    buy_ema_open_mult_6 = DecimalParameter(
        0.02, 0.03, default=0.025, space='buy', decimals=3, optimize=True, load=True)
    ...
    buy_volume_7 = DecimalParameter(
        1.0, 10.0, default=2.0, space='buy', decimals=1, optimize=True, load=True)
    ...
    buy_rsi_8 = DecimalParameter(
        36.0, 40.0, default=20.0, space='buy', decimals=1, optimize=True, load=True)
    ...
    buy_volume_9 = DecimalParameter(
        1.0, 4.0, default=1.0, space='buy', decimals=2, optimize=True, load=True)
    buy_ma_offset_9 = DecimalParameter(
        0.94, 0.99, default=0.97, space='buy', decimals=3, optimize=True, load=True)
    ...
    buy_mfi_9 = DecimalParameter(
        36.0, 65.0, default=30.0, space='buy', decimals=1, optimize=True, load=True)

    buy_volume_10 = DecimalParameter(
        1.0, 8.0, default=2.4, space='buy', decimals=1, optimize=True, load=True)
    buy_ma_offset_10 = DecimalParameter(
        0.93, 0.97, default=0.944, space='buy', decimals=3, optimize=True, load=True)
    ...
    buy_min_inc_11 = DecimalParameter(
        0.005, 0.05, default=0.022, space='buy', decimals=3, optimize=True, load=True)
    ...
    buy_rsi_11 = DecimalParameter(
        30.0, 48.0, default=48.0, space='buy', decimals=1, optimize=True, load=True)
    buy_mfi_11 = DecimalParameter(
        36.0, 56.0, default=38.0, space='buy', decimals=1, optimize=True, load=True)

    buy_volume_12 = DecimalParameter(
        1.0, 10.0, default=1.7, space='buy', decimals=1, optimize=True, load=True)
    buy_ma_offset_12 = DecimalParameter(
        0.93, 0.97, default=0.936, space='buy', decimals=3, optimize=True, load=True)
    buy_rsi_12 = DecimalParameter(
        26.0, 40.0, default=30.0, space='buy', decimals=1, optimize=True, load=True)
    buy_ewo_12 = DecimalParameter(
        2.0, 6.0, default=2.0, space='buy', decimals=1, optimize=True, load=True)

    buy_volume_13 = DecimalParameter(
        1.0, 10.0, default=1.6, space='buy', decimals=1, optimize=True, load=True)
    buy_ma_offset_13 = DecimalParameter(
        0.93, 0.98, default=0.978, space='buy', decimals=3, optimize=True, load=True)
    buy_ewo_13 = DecimalParameter(-14.0, -7.0, default=-10.4,
                                  space='buy', decimals=1, optimize=True, load=True)
    ...
    buy_bb_offset_14 = DecimalParameter(
        0.98, 1.0, default=0.986, space='buy', decimals=3, optimize=True, load=True)
    buy_ma_offset_14 = DecimalParameter(
        0.93, 0.99, default=0.97, space='buy', decimals=3, optimize=True, load=True)

    buy_volume_15 = DecimalParameter(
        1.0, 10.0, default=2.0, space='buy', decimals=1, optimize=True, load=True)
    buy_ema_open_mult_15 = DecimalParameter(
        0.02, 0.04, default=0.018, space='buy', decimals=3, optimize=True, load=True)
    ...
    buy_rsi_15 = DecimalParameter(
        30.0, 50.0, default=28.0, space='buy', decimals=1, optimize=True, load=True)
    ...
    buy_ewo_16 = DecimalParameter(
        4.0, 8.0, default=2.8, space='buy', decimals=1, optimize=True, load=True)

    buy_volume_17 = DecimalParameter(
        0.5, 8.0, default=2.0, space='buy', decimals=1, optimize=True, load=True)
    buy_ma_offset_17 = DecimalParameter(
        0.93, 0.98, default=0.958, space='buy', decimals=3, optimize=True, load=True)
    ...
    buy_volume_20 = DecimalParameter(
        0.5, 6.0, default=1.2, space='buy', decimals=1, optimize=True, load=True)
    ...
    buy_rsi_20 = DecimalParameter(
        20.0, 36.0, default=26.0, space='buy', decimals=1, optimize=True, load=True)
